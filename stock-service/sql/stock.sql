...
(8, 'FACTOR_CATEGORY', '因子分类', '因子大类', 1, 8),
(9, 'RESEARCH_RATING', '研报评级', '研报投资评级', 1, 9),
(10, 'SELL_ACTION', '卖出动作', '持仓卖出动作', 1, 10),
(11, 'REPORT_TYPE', '财报类型', '定期报告类型', 1, 11),
(12, 'TASK_STATUS', '任务状态', '调度任务状态', 1, 12),
(13, 'TASK_TRIGGER_TYPE', '任务触发类型', '调度触发方式', 1, 13),
(14, 'BACKTEST_STATUS', '回测状态', '回测任务状态', 1, 14),
(15, 'DATA_QUALITY_LEVEL', '数据质量等级', '数据质检等级', 1, 15),
(16, 'FACTOR_STATUS', '因子状态', '因子启用状态', 1, 16),
(17, 'MARKET', '交易市场', '股票交易市场', 1, 17),
(18, 'RECOMMEND_CORR_GROUP', '推荐相关组', '推荐相关性分组', 1, 18),
(19, 'RECOMMEND_REASON', '推荐理由', '推荐生成理由', 1, 19),
(20, 'SCREEN_OUTLIER', '异常值处理', '因子异常值处理', 1, 20),
(21, 'SCREEN_NORMALIZE', '标准化方法', '因子标准化', 1, 21),
(22, 'SCREEN_ORTHOGONAL', '正交化方法', '因子正交化', 1, 22),
(23, 'SCREEN_NEUTRAL', '中性化方法', '因子中性化', 1, 23),
(24, 'SCREEN_WEIGHT_MODE', '组合权重方式', '因子加权方式', 1, 24),
(25, 'SCREEN_FILTER_OP', '筛选操作符', '因子筛选运算', 1, 25),
(26, 'SECTOR_CATEGORY', '板块分类', '行业板块分类', 1, 26),
(27, 'LLM_RISK_LEVEL', 'LLM风险等级', '大模型风险等级', 1, 27),
(28, 'LLM_REC', 'LLM建议', 'LLM投资建议', 1, 28),
(29, 'ALERT_TYPE', '告警类型', '预警事件类型', 1, 29),
(30, 'EVENT_TYPE', '事件类型', '市场事件类型', 1, 30),
(31, 'MENU_TYPE', '菜单类型', '系统菜单类型', 1, 31),
(32, 'ROLLING_OP', '滚动操作', '滚动回测操作', 1, 32),
...
(25, 'FACTOR_CATEGORY', 'MOMENTUM', '动量', 4, 'orange', 1),
(26, 'FACTOR_CATEGORY', 'VOLATILITY', '波动率', 5, 'purple', 1),
(27, 'FACTOR_CATEGORY', 'LIQUIDITY', '流动性', 6, 'geekblue', 1),
(28, 'FACTOR_CATEGORY', 'VOLUME_PRICE', '量价', 7, 'magenta', 1),
(29, 'FACTOR_CATEGORY', 'SENTIMENT', '情绪', 8, 'red', 1),
(30, 'FACTOR_CATEGORY', 'TECHNICAL', '技术', 9, 'gold', 1),
(31, 'FACTOR_CATEGORY', 'FUNDAMENTAL', '基本面', 10, 'volcano', 1),
(32, 'RESEARCH_RATING', 'BUY', '买入', 1, 'red', 1),
(33, 'RESEARCH_RATING', 'OVERWEIGHT', '增持', 2, 'volcano', 1),
(34, 'RESEARCH_RATING', 'NEUTRAL', '中性', 3, 'default', 1),
(35, 'RESEARCH_RATING', 'UNDERWEIGHT', '减持', 4, 'blue', 1),
(36, 'RESEARCH_RATING', 'SELL', '卖出', 5, 'green', 1),
(37, 'SELL_ACTION', 'HOLD', '持有', 1, 'default', 1),
(38, 'SELL_ACTION', 'REDUCE', '减仓', 2, 'orange', 1),
(39, 'SELL_ACTION', 'SELL', '卖出', 3, 'red', 1),
(40, 'REPORT_TYPE', 'ANNUAL', '年报', 1, 'blue', 1),
(41, 'REPORT_TYPE', 'Q1', '一季报', 2, 'cyan', 1),
(42, 'REPORT_TYPE', 'SEMI', '中报', 3, 'green', 1),
(43, 'REPORT_TYPE', 'Q3', '三季报', 4, 'purple', 1),
(44, 'TASK_STATUS', 'PENDING', '待执行', 1, 'default', 1),
(45, 'TASK_STATUS', 'RUNNING', '执行中', 2, 'blue', 1),
(46, 'TASK_STATUS', 'SUCCESS', '成功', 3, 'green', 1),
(47, 'TASK_STATUS', 'FAILED', '失败', 4, 'red', 1),
(48, 'TASK_STATUS', 'TIMEOUT', '超时', 5, 'orange', 1),
(49, 'TASK_TRIGGER_TYPE', 'MANUAL', '手动', 1, 'default', 1),
(50, 'TASK_TRIGGER_TYPE', 'SCHEDULE', '定时', 2, 'blue', 1),
(51, 'TASK_TRIGGER_TYPE', 'EVENT', '事件', 3, 'purple', 1),
(52, 'BACKTEST_STATUS', 'PENDING', '待执行', 1, 'default', 1),
(53, 'BACKTEST_STATUS', 'RUNNING', '执行中', 2, 'blue', 1),
(54, 'BACKTEST_STATUS', 'SUCCESS', '成功', 3, 'green', 1),
(55, 'BACKTEST_STATUS', 'FAILED', '失败', 4, 'red', 1),
(56, 'BACKTEST_STATUS', 'CANCELED', '已取消', 5, 'orange', 1),
(57, 'DATA_QUALITY_LEVEL', 'ERROR', '错误', 1, 'red', 1),
(58, 'DATA_QUALITY_LEVEL', 'WARN', '警告', 2, 'orange', 1),
(59, 'DATA_QUALITY_LEVEL', 'INFO', '提示', 3, 'blue', 1),
(60, 'DATA_QUALITY_LEVEL', 'OK', '正常', 4, 'green', 1),
(61, 'FACTOR_STATUS', 'DRAFT', '草稿', 1, 'default', 1),
(62, 'FACTOR_STATUS', 'ACTIVE', '启用', 2, 'green', 1),
(63, 'FACTOR_STATUS', 'DISABLED', '停用', 3, 'red', 1),
(64, 'FACTOR_STATUS', 'DEPRECATED', '废弃', 4, 'orange', 1),
(65, 'MARKET', 'SH', '沪市', 1, 'red', 1),
(66, 'MARKET', 'SZ', '深市', 2, 'green', 1),
(67, 'MARKET', 'BJ', '北交所', 3, 'blue', 1),
(68, 'MARKET', 'HK', '港股', 4, 'purple', 1),
(69, 'RECOMMEND_CORR_GROUP', 'INDUSTRY', '行业', 1, 'blue', 1),
(70, 'RECOMMEND_CORR_GROUP', 'STYLE', '风格', 2, 'cyan', 1),
(71, 'RECOMMEND_CORR_GROUP', 'SECTOR', '板块', 3, 'green', 1),
(72, 'RECOMMEND_REASON', 'UNDERVALUATION', '低估', 1, 'red', 1),
(73, 'RECOMMEND_REASON', 'MOMENTUM', '动量', 2, 'orange', 1),
(74, 'RECOMMEND_REASON', 'FUNDAMENTAL', '基本面', 3, 'blue', 1),
(75, 'RECOMMEND_REASON', 'TECHNICAL', '技术', 4, 'purple', 1),
(76, 'RECOMMEND_REASON', 'RISK_CONTROL', '风控', 5, 'default', 1),
(77, 'SCREEN_OUTLIER', 'WINSORIZE', '缩尾', 1, 'blue', 1),
(78, 'SCREEN_OUTLIER', 'TRIM', '截尾', 2, 'orange', 1),
(79, 'SCREEN_OUTLIER', 'NONE', '不处理', 3, 'default', 1),
(80, 'SCREEN_NORMALIZE', 'ZSCORE', '标准分', 1, 'blue', 1),
(81, 'SCREEN_NORMALIZE', 'RANK', '排序', 2, 'cyan', 1),
(82, 'SCREEN_NORMALIZE', 'MINMAX', '归一化', 3, 'green', 1),
(83, 'SCREEN_NORMALIZE', 'NONE', '不处理', 4, 'default', 1),
(84, 'SCREEN_ORTHOGONAL', 'GRAM_SCHMIDT', '施密特正交', 1, 'blue', 1),
(85, 'SCREEN_ORTHOGONAL', 'NONE', '不正交', 2, 'default', 1),
(86, 'SCREEN_NEUTRAL', 'INDUSTRY', '行业中性', 1, 'blue', 1),
(87, 'SCREEN_NEUTRAL', 'MARKET_CAP', '市值中性', 2, 'green', 1),
(88, 'SCREEN_NEUTRAL', 'BOTH', '双重中性', 3, 'purple', 1),
(89, 'SCREEN_NEUTRAL', 'NONE', '不中性', 4, 'default', 1),
(90, 'SCREEN_WEIGHT_MODE', 'EQUAL', '等权', 1, 'default', 1),
(91, 'SCREEN_WEIGHT_MODE', 'IC_WEIGHTED', 'IC加权', 2, 'blue', 1),
(92, 'SCREEN_WEIGHT_MODE', 'OPTIMIZED', '优化', 3, 'green', 1),
(93, 'SCREEN_WEIGHT_MODE', 'FACTOR_WEIGHTED', '因子加权', 4, 'cyan', 1),
(94, 'SCREEN_FILTER_OP', 'GT', '> 大于', 1, 'blue', 1),
(95, 'SCREEN_FILTER_OP', 'LT', '< 小于', 2, 'blue', 1),
(96, 'SCREEN_FILTER_OP', 'GE', '>= 大于等于', 3, 'cyan', 1),
(97, 'SCREEN_FILTER_OP', 'LE', '<= 小于等于', 4, 'cyan', 1),
(98, 'SCREEN_FILTER_OP', 'EQ', '= 等于', 5, 'green', 1),
(99, 'SCREEN_FILTER_OP', 'NE', '!= 不等于', 6, 'orange', 1),
(100, 'SCREEN_FILTER_OP', 'BETWEEN', '区间', 7, 'purple', 1),
(101, 'SECTOR_CATEGORY', 'TECH', '科技', 1, 'blue', 1),
(102, 'SECTOR_CATEGORY', 'NEW_ENERGY', '新能源', 2, 'green', 1),
(103, 'SECTOR_CATEGORY', 'MEDICAL', '医药', 3, 'red', 1),
(104, 'SECTOR_CATEGORY', 'DEFENSE', '国防', 4, 'orange', 1),
(105, 'SECTOR_CATEGORY', 'CONSUMER', '消费', 5, 'purple', 1),
(106, 'LLM_RISK_LEVEL', 'LOW', '低', 1, 'green', 1),
(107, 'LLM_RISK_LEVEL', 'MEDIUM', '中', 2, 'orange', 1),
(108, 'LLM_RISK_LEVEL', 'HIGH', '高', 3, 'red', 1),
(109, 'LLM_REC', 'STRONG_BUY', '强烈推荐', 1, 'red', 1),
(110, 'LLM_REC', 'BUY', '推荐', 2, 'volcano', 1),
(111, 'LLM_REC', 'HOLD', '观望', 3, 'default', 1),
(112, 'LLM_REC', 'SELL', '不推荐', 4, 'green', 1),
(113, 'LLM_REC', 'STRONG_SELL', '强烈不推荐', 5, 'blue', 1),
(114, 'ALERT_TYPE', 'PRICE', '价格', 1, 'red', 1),
(115, 'ALERT_TYPE', 'VOLUME', '成交量', 2, 'blue', 1),
(116, 'ALERT_TYPE', 'NEWS', '新闻', 3, 'purple', 1),
(117, 'ALERT_TYPE', 'FACTOR', '因子', 4, 'cyan', 1),
(118, 'ALERT_TYPE', 'POSITION', '持仓', 5, 'orange', 1),
(119, 'EVENT_TYPE', 'EARNINGS', '财报', 1, 'blue', 1),
(120, 'EVENT_TYPE', 'DIVIDEND', '分红', 2, 'green', 1),
(121, 'EVENT_TYPE', 'MERGER', '并购', 3, 'purple', 1),
(122, 'EVENT_TYPE', 'ANNOUNCEMENT', '公告', 4, 'orange', 1),
(123, 'MENU_TYPE', 'DIR', '目录', 1, 'default', 1),
(124, 'MENU_TYPE', 'MENU', '菜单', 2, 'blue', 1),
(125, 'MENU_TYPE', 'BUTTON', '按钮', 3, 'green', 1),
(126, 'ROLLING_OP', 'ADD', '加入', 1, 'green', 1),
(127, 'ROLLING_OP', 'REMOVE', '移除', 2, 'red', 1),
(128, 'ROLLING_OP', 'UPDATE', '更新', 3, 'blue', 1),
(129, 'ROLLING_FREQ', 'DAILY', '日频', 1, 'blue', 1),
(130, 'ROLLING_FREQ', 'WEEKLY', '周频', 2, 'cyan', 1),
(131, 'ROLLING_FREQ', 'MONTHLY', '月频', 3, 'green', 1),
(132, 'ROLLING_FREQ', 'QUARTERLY', '季频', 4, 'purple', 1),
(133, 'ROLLING_WEIGHT_MODE', 'EQUAL', '等权', 1, 'default', 1),
(134, 'ROLLING_WEIGHT_MODE', 'IC_WEIGHTED', 'IC加权', 2, 'blue', 1),
(135, 'ROLLING_WEIGHT_MODE', 'OPTIMIZED', '优化', 3, 'green', 1),
(136, 'ROLLING_ORDER_TYPE', 'MARKET', '市价单', 1, 'default', 1),
(137, 'ROLLING_ORDER_TYPE', 'LIMIT', '限价单', 2, 'blue', 1),
(138, 'ROLLING_ORDER_TYPE', 'STOP', '止损单', 3, 'red', 1),
(139, 'ROLLING_ORDER_TYPE', 'STOP_LIMIT', '止损限价', 4, 'volcano', 1),
(140, 'ROLLING_ORDER_TYPE', 'TRAILING_STOP', '追踪止损', 5, 'purple', 1),
