...
const PRESETS = [
  { name: '经典多因子', desc: '均衡配置：价值+动量+波动率+流动性+质量+成长，适合中长期持有',
    factors: ['SIZE(-1)', 'MOM20(+1)', 'VOL20(-1)', 'AMIHUD(-1)', 'FIN_ROE(+1)', 'FIN_REVENUE_YOY(+1)', 'MOM5(-1,≤70)'],
  ...
  { name: '技术动量', desc: '纯技术面选股：趋势跟踪+量价确认，适合短线交易',
    factors: ['MOM20(+1.5)', 'MOM60', 'MOM5(≤70)', 'SAR', 'VOLUME_RATIO', 'BOLL_POS'],
  ...
  { name: '趋势突破', desc: '量价配合的趋势跟踪：强动量+放量确认，捕捉持续上涨个股',
    factors: ['MOM60(>5%,权重2)', 'MOM20(>0%)', 'VOLUME_RATIO(>1,权重1.5)', 'BOLL_POS', 'TURNOVER_ANOMALY(>0)', 'VOL20(-0.5)'],
  ...
  { name: '低估反转', desc: '超跌低估值个股的均值回归：短期弱势+基本面支撑+估值低位',
    factors: ['REVERSAL5(+1.5)', 'MOM5(≤40,权重1.5)', 'FIN_BPS(>2元)', 'FIN_ROE(>5%)', 'VOL20', 'FIN_DEBT_TO_ASSET(<65%)'],
    suitable: '逆向投资/左侧交易', style: 'volcano', icon: '🔄' },
  { name: '量价异动', desc: '捕捉资金异常涌入迹象：成交量突变+量价背离修复',
    factors: ['TURNOVER_ANOMALY(>1.2,权重2)', 'TURNOVER_ANOMALY(>1.2)', 'VROC12(>0)', 'VOL20(-0.5)', 'MOM5(>0)', 'SIZE(-0.5)'],
  ...
  { name: '综合打分', desc: '技术+基本面+情绪全覆盖：八因子均衡打分，降低单一因子的随机性',
    factors: ['FIN_ROE', 'FIN_REVENUE_YOY', 'MOM60', 'VOL20', 'SIZE', 'FIN_EARNINGS_QUALITY', 'VOLUME_RATIO', 'MOM5(≤70)'],
