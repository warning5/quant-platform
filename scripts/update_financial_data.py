...
用法：
  python update_data/update_financial_data.py [--year 2024] [--force]
  --year    指定年份（默认最近3个完整报告期：2022、2023、2024）
...
def main():
    ...
    if args.year:
        ...
        years = [y for y in range(current_year - 3, current_year) if y >= 2015]
    print(f"采集年份: {years}")
